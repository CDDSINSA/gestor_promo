...
export function buildCatalogosFromCampanas(campanas = []) {
  return campanas
    ...
    .map((item) => ({
      ...
      notificaciones_envivo: item.notificaciones_envivo,
...
export function toActividad(row, compradorById = {}) {
  ...
  return {
    ...
    solicitante,
    solicitante_buyer_id: row.solicitante_buyer_id || null,
    estado: row.estado,
...
export function toDbCampana(row, catalogosById = {}, compradorByName = {}) {
  ...
  return {
    ...
    solicitante_buyer_id: row.solicitante_buyer_id || compradorByName[solicitante]?.id || null,
    ...
    notificaciones_envivo: catalogo.notificaciones_envivo === undefined || catalogo.notificaciones_envivo === "" ? true : toBoolean(catalogo.notificaciones_envivo),
...
export function toDbPromocion(row, campanaByLegacy = {}, compradorByName = {}) {
  return {
    ...
    buyer_id: row.buyer_id || compradorByName[cleanText(row.comprador)]?.id || null,
